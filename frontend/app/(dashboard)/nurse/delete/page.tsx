...
export default function NurseDeleteAccountPage() {
  ...
  const handleDelete = async () => {
    ...
    const confirmed = confirm("Are you sure you want to permanently delete your career profile? All applications, resume data, and settings will be permanently removed. This action cannot be undone.");
    ...
    try {
      ...
      logout();
      alert("Account deleted successfully. Good luck with your career search.");
      router.push("/");
    } catch (error) {
  ...
  return (
    <div className="p-8 max-w-4xl space-y-8 font-['DM_Sans',sans-serif]">
      <div className="header-section">
        <h1 className="text-3xl font-black text-[#002868] tracking-tight">Account Settings</h1>
        <p className="text-gray-500 font-medium mt-2">Manage your career profile and account termination settings.</p>
      </div>
      ...
      <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden">
        <div className="p-8 border-b border-gray-100 flex items-center gap-3">
          ...
          <h2 className="text-lg font-black text-[#002868]">Delete Career Profile</h2>
        </div>
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-2xl p-6 flex gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-amber-800/80 text-sm font-medium leading-relaxed">
                Deleting your account will permanently remove all your resume files, job applications, and shortlisted jobs. This data cannot be recovered.
              </p>
            </div>
          </div>
